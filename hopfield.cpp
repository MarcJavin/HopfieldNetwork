...
int main (int argc, char *argv[]){
	...
	Hopfield network = Hopfield(720, 1280);
	
	//~ cv::Mat example(90,120, CV_8UC1, cv::Scalar(0));
	
	cv::Mat example = cv::imread("/home/markus/Documents/ReconnaissanceEmotions/images/entrees/1.jpg", 0);
	cv::imwrite("example.jpg", example);
	
	cv::Mat example2 = cv::imread("/home/markus/Documents/ReconnaissanceEmotions/images/entrees/nico.jpg", 0);
	cv::imwrite("example2.jpg", example2);
	
	cv::Mat example3 = cv::imread("/home/markus/Documents/ReconnaissanceEmotions/images/entrees/anthony.jpg", 0);
	...
	cv::Mat test = cv::imread("/home/markus/Documents/ReconnaissanceEmotions/images/entrees/nicoco.jpg", 0);
